...
CREATE TABLE IF NOT EXISTS theme_presets (
  ...
  -- Global Color Tokens
  color_primary VARCHAR(9) DEFAULT '#667eea',
  color_secondary VARCHAR(9) DEFAULT '#764ba2',
  color_accent VARCHAR(9) DEFAULT '#00d4ff',
  color_surface VARCHAR(9) DEFAULT 'rgba(30, 30, 40, 0.9)',
  color_text_primary VARCHAR(9) DEFAULT '#ffffff',
  color_text_secondary VARCHAR(9) DEFAULT 'rgba(255, 255, 255, 0.7)',
  color_success VARCHAR(9) DEFAULT '#4caf50',
  color_danger VARCHAR(9) DEFAULT '#ff6b6b',
  color_warning VARCHAR(9) DEFAULT '#ffc107',
  color_glow VARCHAR(9) DEFAULT '#667eea',
  color_shadow VARCHAR(9) DEFAULT 'rgba(0, 0, 0, 0.5)',
...
CREATE TABLE IF NOT EXISTS user_themes (
  ...
  color_text_primary VARCHAR(9),
  color_text_secondary VARCHAR(9),
  color_success VARCHAR(9),
  color_danger VARCHAR(9),
  color_warning VARCHAR(9),
  color_glow VARCHAR(9),
  color_shadow VARCHAR(9),
...
CREATE TABLE IF NOT EXISTS widget_theme_overrides (
  ...
  override_color_primary VARCHAR(9),
  override_color_secondary VARCHAR(9),
  override_color_accent VARCHAR(9),
  override_color_surface VARCHAR(9),
  override_color_text_primary VARCHAR(9),
  override_color_text_secondary VARCHAR(9),
  override_color_glow VARCHAR(9),
